...
public class Play extends JPanel implements ActionListener, KeyListener
{
    ...
    private double velocity_ball = 5.0;
    private double velocity_paddle = 20;
...
// ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------    
    ...
    public void keyPressed( KeyEvent e )
    {
        ...
        if( code == KeyEvent.VK_LEFT )				// VK : Virtual Key
            left();
        
        // If Key Pressed Is SpaceBar.
        if( code == KeyEvent.VK_SPACE )				// VK : Virtual Key
            space();
        
        // If Key Pressed Is Up.
        if( code == KeyEvent.VK_UP )				// VK : Virtual Key
            up();
        
        // If Key Pressed Is Down.
        if( code == KeyEvent.VK_DOWN )				// VK : Virtual Key
            down();
        
    }
    
    
    // Function To Return Width Of The Application.	
    public int getWidth()
    {
    ...
    // Function To Return Height Of The Application.	
